...
function comprobarRFC(elmnt){
  ...
  $(document).ready(function(){
    ...
    $("#imagen").change(function(){
      ...
      if((ruta.includes(".jpge"))||(ruta.includes(".png"))||(ruta.includes(".jpg"))){
        document.getElementById("imgF").style="font-size: 0.75rem;color:green";
        document.getElementById("imgF").innerText="Formato de imagen aceptado";

        document.getElementById("btnguardarS").removeAttribute("disabled");
      }
      else{
        document.getElementById("imgF").style="font-size: 0.75rem;color:red";
        document.getElementById("imgF").innerText="Formato NO aceptado";
        document.getElementById("btnguardarS").setAttribute("disabled","disabled");
      }
    });
